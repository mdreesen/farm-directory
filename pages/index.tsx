...
export default function HomePage() {
  const abstract = (
    <section>
      <h2>About</h2>
      We are a small group of folks with a strong desire to connect local consumers to local farmers. The idea was
  ...
  const whoWeAre = (
    <section>
      ...
      FarmDirectory.net is a directory of farm products, farmers, and farm-related businesses and products. The
