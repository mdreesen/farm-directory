...
export default async function Navigation() {
  ...
  const loginSettings = user?.user?.sid ? (
  ...
  ) : <a href="/api/auth/login" className={'text-gray-300 hover:bg-gray-700 hover:text-white block rounded-md px-3 py-2 text-base font-medium'}>Login</a>;
