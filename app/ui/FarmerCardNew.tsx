...
import styles from '@/app/styles/FarmerCardNew.module.css';
...
export default async function FarmerCard(farmerData: any) {
    ...
    return (
        <div className={styles["card"]}>
            ...
            <span>About Me</span>
            <p className={styles["info"]}>I’m Walter, a multidisciplinary designer who focuses on telling my clients’ stories visually, through enjoyable and meaningful experiences. I specialize in responsive websites and functional user interfaces.</p>
