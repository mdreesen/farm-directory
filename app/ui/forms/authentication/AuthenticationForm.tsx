...
export function AuthenticationForm() {
    ...
    const toggleAuth = (
        <label className="inline-flex items-center cursor-pointer">
            <span className="me-3 text-sm font-medium" dangerouslySetInnerHTML={{ __html: "I'm looking for farm products" }} />
            ...
            <span className="ms-3 text-sm font-medium" dangerouslySetInnerHTML={{ __html: "I'm a farm/farm service provider" }} />
        </label>
    )
