...
export function AuthenticationForm() {
    ...
    const toggleAuth = (
        <label className="inline-flex items-center cursor-pointer">
            <span className="me-3 text-sm font-medium">I am looking for farm products</span>
            ...
            <span className="ms-3 text-sm font-medium">I am a farm/farm service provider</span>
        </label>
    )
