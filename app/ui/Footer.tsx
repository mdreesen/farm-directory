    ...
    <>
      <div className='flex flex-col gap-2'>
        ...
        <div className='flex justify-around'>
          <a className="hover:text-yellow-500" aria-label="Visit TrendyMinds Facebook" href="https://www.facebook.com/thefarmdirectory" target="_blank">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 320 512" className="h-3">
          ...
          <a className="hover:text-yellow-500" aria-label="Visit TrendyMinds Instagram" href="https://www.instagram.com/thefarmdirectory/?igsh=M2F5dW1iaDA3Ym9u" target="_blank">
      ...
      <div className="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
        ...
        <div className="sm:flex sm:items-center sm:justify-between">
          ...
          <div className="flex mt-4 sm:justify-center sm:mt-0">
            <a href="https://www.facebook.com/thefarmdirectory" className="text-gray-500 hover:text-gray-900 dark:hover:text-white">
              <svg className="w-4 h-4" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 8 19">
                <path fillRule="evenodd" d="M6.135 3H8V0H6.135a4.147 4.147 0 0 0-4.142 4.142V6H0v3h2v9.938h3V9h2.021l.592-3H5V3.591A.6.6 0 0 1 5.592 3h.543Z" clipRule="evenodd" />
              </svg>
              <span className="sr-only">Facebook page</span>
            </a>
            <a href="https://www.instagram.com/thefarmdirectory/?igsh=M2F5dW1iaDA3Ym9u" className="text-gray-500 hover:text-gray-900 dark:hover:text-white">
