...
export const metadata: Metadata = {
  title: 'Livestock | Cattle Live Animals',
  description: 'Live livestock & Cattle, live animals Farm Directory',
}
      ...
      <div className={styles['container']}>
        <WrapperLocation>
          <Suspense fallback={<CardsSkeleton />}>
            <CategoryPage categoryName={'Live Livestock/Cattle'} query={query} />
          </Suspense>
        </WrapperLocation>
      </div>
    </>
