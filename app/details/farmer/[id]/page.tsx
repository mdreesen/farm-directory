            ...
            >
              {farmer.products.map((item: any) => (
                <li key={item._id}>
                  ...
                  <h3 className="mt-6 text-base font-semibold leading-7 tracking-tight text-gray-900">{item.product_title}</h3>
                  <p className="text-sm leading-6 text-gray-600">{item.product_description}</p>
                </li>
              ))}
            </ul>
          </div>
